...
const workerEnvironmentSchema = commonServerSchema
  .extend({
    ...
    SEARCH_REBUILD_BATCH_SIZE: positiveInteger(250, 1_000),
    SEARCH_REBUILD_POLL_INTERVAL_MS: positiveInteger(5_000, 60_000),
    SEARCH_REBUILD_LEASE_SECONDS: positiveInteger(300, 3_600),
