...
Known gaps: SEARCH-004 owns versioned synonyms、suggestions and low-frequency-sensitive trending privacy；SEARCH-005 owns rebuild/catch-up/validation/atomic alias rollback；SEARCH-006 owns relevance evaluation and dashboards；WEB-001 owns public list/detail/filter pages；production relevance and latency SLO claims require observed Beta traffic；PR #35 evidence-head checks and protected merge remain pending
