...
Known gaps: Email/SMS/push adapters、preferences、unsubscribe、provider retries/receipts and production OTP/password delivery remain `NOTIF-002`；notification bulk actions and Admin notification operations are not part of this baseline；Job and the remaining Listing verticals continue with LIST-006/007；the evidence-head rerun and protected merge remain pending
